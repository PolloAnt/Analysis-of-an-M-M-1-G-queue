//
// Generated file, do not edit! Created by nedtool 5.5 from queueinglib/Job.msg.
//
...
::omnetpp::simtime_t Job_Base::getDeadline() const
{
    return this->deadline;
}

void Job_Base::setDeadline(::omnetpp::simtime_t deadline)
{
    this->deadline = deadline;
}

::omnetpp::simtime_t Job_Base::getServiceTime() const
{
    return this->serviceTime;
}

void Job_Base::setServiceTime(::omnetpp::simtime_t serviceTime)
{
...
int JobDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "serviceTime")==0) return base+8;
...
std::string JobDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 7: return simtime2string(pp->getDeadline());
        case 8: return simtime2string(pp->getServiceTime());
        default: return "";
    }
}
...
bool JobDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 7: pp->setDeadline(string2simtime(value)); return true;
        case 8: pp->setServiceTime(string2simtime(value)); return true;
